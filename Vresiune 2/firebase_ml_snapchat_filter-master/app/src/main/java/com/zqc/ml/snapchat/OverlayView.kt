...
class OverlayView(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private val ochelariBitmap: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.ochelaridif)

    // The cigarette bitmap
    private val cigaretteBitmap: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.cigarette)
    private val tigara2Bitmap: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.tigara2)
    ...
    private fun drawGlasses2(canvas: Canvas, face: FirebaseVisionFace) {
        val leftEye = face.getLandmark(FirebaseVisionFaceLandmark.LEFT_EYE)
        val rightEye = face.getLandmark(FirebaseVisionFaceLandmark.RIGHT_EYE)
    ...
    private fun drawCigarette2(canvas: Canvas, face: FirebaseVisionFace) {
        val rightMouth = face.getLandmark(FirebaseVisionFaceLandmark.RIGHT_MOUTH)
        val leftMouth = face.getLandmark(FirebaseVisionFaceLandmark.LEFT_MOUTH)
        ...
        if (leftMouth != null && rightMouth != null) {
            ...
            //canvas.drawBitmap(cigaretteBitmap, null, cigaretteRect, null)
            canvas.drawBitmap(tigara2Bitmap, null, cigaretteRect, null)
        }
    }
